...
class ListAllTasksTestCase(APITestCase):
    def setUp(self) -> None:
        self.user = Users.objects.create_user(
            email="maamoun.haj.najeeb@gmail.com", password="17AiGz48rhe", full_name="Maamoun Haj Najeeb")
    ...
    def test_list_all_tasks(self):
        url = f"{app_url}user_tasks/"
        response = self.client.get(path=url
            , headers=dict(Authorization=f"Bearer {self.create_access_token()}"))
        
        self.assertEqual(len(response.json()[0]["tasks"]), 2)
        self.assertEqual(response.json()[0]["user"], "Maamoun Haj Najeeb")
        self.assertEqual(response.json()[0]["tasks"][1]["due_date"], "21/2/2024")


class ListAllTasksNotAuthenticatedTestCase(APITestCase):
    def setUp(self) -> None:
        self.user = Users.objects.create_user(
            email="maamoun.haj.najeeb@gmail.com", password="17AiGz48rhe", full_name="Maamoun Haj Najeeb")
...
class SpecificDatesTasksTestCase(APITestCase):
    def setUp(self) -> None:
        self.user = Users.objects.create_user(
            email="maamoun.haj.najeeb@gmail.com", password="17AiGz48rhe", full_name="Maamoun Haj Najeeb")
    ...
    def test_list_all_tasks(self):
        url = f"{app_url}user_tasks/2024/2/21/"
        response = self.client.get(path=url
            , headers=dict(Authorization=f"Bearer {self.create_access_token()}"))
        ...
        self.assertEqual(response.json()[0]["user"], "Maamoun Haj Najeeb")
        self.assertEqual(response.json()[0]["tasks"][1]["due_date"], "21/2/2024")
        self.assertEqual(response.json()[0]["tasks"][1]["piriority"], "Med")


class SpecificDatesTasksNotAuthenticatedTestCase(APITestCase):
    def setUp(self) -> None:
        self.user = Users.objects.create_user(
            email="maamoun.haj.najeeb@gmail.com", password="17AiGz48rhe", full_name="Maamoun Haj Najeeb")
    ...
    def test_list_all_tasks(self):
        url = f"{app_url}user_tasks/2024/2/22/"
        response = self.client.get(path=url)
